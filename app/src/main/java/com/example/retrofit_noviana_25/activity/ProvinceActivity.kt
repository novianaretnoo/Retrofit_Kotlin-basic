package com.example.retrofit_noviana_25.activity
...
import com.example.retrofit_noviana_25.R
import com.example.retrofit_noviana_25.adapter.ProvinceAdapter
import com.example.retrofit_noviana_25.api.RetrofitClient
...
class ProvinceActivity : AppCompatActivity() {
    ...
    private fun showProvince() {
        val rvProvince : RecyclerView = findViewById(R.id.rvProvince) //tetap mencoba walau ngarang :)
